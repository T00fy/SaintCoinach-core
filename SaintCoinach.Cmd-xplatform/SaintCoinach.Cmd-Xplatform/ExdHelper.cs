...
namespace SaintCoinach.Cmd_Xplatform {
    static class ExdHelper {
        ...
        public static List<Language> ConvertLanguages(IEnumerable<string> languageStrings) {
            var languages = new List<Language>();
            foreach (var languageString in languageStrings) {
                Language language;
                if (Enum.TryParse(languageString, out language)) {
        ...
        public static bool IsUnescaped(object self) {
